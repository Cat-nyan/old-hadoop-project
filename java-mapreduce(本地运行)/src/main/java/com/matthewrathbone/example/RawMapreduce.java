...
public class RawMapreduce {
  ...
  public static void main( String[] args ) throws Exception {
    Path transactions = new Path("hdfs://master:9000/user/path/transactions");
    Path users = new Path("hdfs://master:9000/user/path/users");
    Path staging = new Path("hdfs://master:9000/user/path/staging");
    Path output = new Path("hdfs://master:9000/user/path/output");
